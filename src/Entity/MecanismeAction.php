...
#[ORM\Entity(repositoryClass: MecanismeActionRepository::class)]
class MecanismeAction
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
     ...
     */
    #[ORM\OneToMany(targetEntity: SignalPotentiel::class, mappedBy: 'mecanismeAction')]
    ...
    public function addSignalPotentiel(SignalPotentiel $signalPotentiel): static
    {
        if (!$this->SignalPotentiel->contains($signalPotentiel)) {
            ...
            $signalPotentiel->setMecanismeAction($this);
        }
    ...
    public function removeSignalPotentiel(SignalPotentiel $signalPotentiel): static
    {
        if ($this->SignalPotentiel->removeElement($signalPotentiel)) {
            ...
            if ($signalPotentiel->getMecanismeAction() === $this) {
                $signalPotentiel->setMecanismeAction(null);
            }
        }
