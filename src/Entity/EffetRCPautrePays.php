...
#[ORM\Entity(repositoryClass: EffetRCPautrePaysRepository::class)]
class EffetRCPautrePays
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
     ...
     */
    #[ORM\OneToMany(targetEntity: SignalPotentiel::class, mappedBy: 'effetRCPautrePays')]
    ...
    public function addSignalPotentiel(SignalPotentiel $signalPotentiel): static
    {
        if (!$this->SignalPotentiel->contains($signalPotentiel)) {
            ...
            $signalPotentiel->setEffetRCPautrePays($this);
        }
    ...
    public function removeSignalPotentiel(SignalPotentiel $signalPotentiel): static
    {
        if ($this->SignalPotentiel->removeElement($signalPotentiel)) {
            ...
            if ($signalPotentiel->getEffetRCPautrePays() === $this) {
                $signalPotentiel->setEffetRCPautrePays(null);
            }
        }
