...
#[ORM\Entity(repositoryClass: ImputabiliteRepository::class)]
class Imputabilite
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
     ...
     */
    #[ORM\OneToMany(targetEntity: SignalPotentiel::class, mappedBy: 'imputabilite')]
    ...
    public function addSignalPotentiel(SignalPotentiel $signalPotentiel): static
    {
        if (!$this->SignalPotentiel->contains($signalPotentiel)) {
            ...
            $signalPotentiel->setImputabilite($this);
        }
    ...
    public function removeSignalPotentiel(SignalPotentiel $signalPotentiel): static
    {
        if ($this->SignalPotentiel->removeElement($signalPotentiel)) {
            ...
            if ($signalPotentiel->getImputabilite() === $this) {
                $signalPotentiel->setImputabilite(null);
            }
        }
