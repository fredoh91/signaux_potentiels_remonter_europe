...
#[ORM\Entity(repositoryClass: LitteratureRepository::class)]
class Litterature
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
     ...
     */
    #[ORM\OneToMany(targetEntity: SignalPotentiel::class, mappedBy: 'litterature')]
    ...
    public function addSignalPotentiel(SignalPotentiel $signalPotentiel): static
    {
        if (!$this->SignalPotentiel->contains($signalPotentiel)) {
            ...
            $signalPotentiel->setLitterature($this);
        }
    ...
    public function removeSignalPotentiel(SignalPotentiel $signalPotentiel): static
    {
        if ($this->SignalPotentiel->removeElement($signalPotentiel)) {
            ...
            if ($signalPotentiel->getLitterature() === $this) {
                $signalPotentiel->setLitterature(null);
            }
        }
