...
#[ORM\Entity(repositoryClass: EssaisCliniquesRepository::class)]
class EssaisCliniques
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
     ...
     */
    #[ORM\OneToMany(targetEntity: SignalPotentiel::class, mappedBy: 'essaisCliniques')]
    ...
    public function addSignalPotentiel(SignalPotentiel $signalPotentiel): static
    {
        if (!$this->SignalPotentiel->contains($signalPotentiel)) {
            ...
            $signalPotentiel->setEssaisCliniques($this);
        }
    ...
    public function removeSignalPotentiel(SignalPotentiel $signalPotentiel): static
    {
        if ($this->SignalPotentiel->removeElement($signalPotentiel)) {
            ...
            if ($signalPotentiel->getEssaisCliniques() === $this) {
                $signalPotentiel->setEssaisCliniques(null);
            }
        }
